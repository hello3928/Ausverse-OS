...
/*
 * Classic 8x8 PC bitmap font — printable ASCII (0x20–0x7E).
...
static const uint8_t font_data[95][8] = {
    ...
    {0x00,0x18,0x18,0x30,0x00,0x00,0x00,0x00}, /* 0x27 ' */
    {0x00,0x0C,0x18,0x30,0x30,0x18,0x0C,0x00}, /* 0x28 ( */
    {0x00,0x30,0x18,0x0C,0x0C,0x18,0x30,0x00}, /* 0x29 ) */
    ...
    {0x00,0x1C,0x30,0x7C,0x66,0x66,0x3C,0x00}, /* 0x36 6 */
    ...
    {0x00,0x06,0x0C,0x18,0x0C,0x06,0x00,0x00}, /* 0x3C < */
    {0x00,0x00,0x7E,0x00,0x7E,0x00,0x00,0x00}, /* 0x3D = */
    {0x00,0x60,0x30,0x18,0x30,0x60,0x00,0x00}, /* 0x3E > */
    {0x00,0x3C,0x66,0x0C,0x18,0x00,0x18,0x00}, /* 0x3F ? */
    {0x00,0x3C,0x66,0x6E,0x6E,0x60,0x3C,0x00}, /* 0x40 @ */
    {0x00,0x18,0x3C,0x66,0x7E,0x66,0x66,0x00}, /* 0x41 A */
    ...
    {0x00,0x3C,0x66,0x60,0x6E,0x66,0x3E,0x00}, /* 0x47 G */
    {0x00,0x66,0x66,0x7E,0x66,0x66,0x66,0x00}, /* 0x48 H */
    {0x00,0x7E,0x18,0x18,0x18,0x18,0x7E,0x00}, /* 0x49 I */
    {0x00,0x06,0x06,0x06,0x66,0x66,0x3C,0x00}, /* 0x4A J */
    ...
    {0x00,0x3C,0x66,0x70,0x1C,0x66,0x3C,0x00}, /* 0x53 S */
    ...
    {0x00,0x06,0x00,0x06,0x06,0x06,0x66,0x3C}, /* 0x6A j */
...
const uint8_t *font_glyph(char c) {
    if (c >= 0x20 && c <= 0x7E)
        return font_data[(uint8_t)c - 0x20];
    return blank;
}
